...
export function PortfolioPage() {
  ...
  useSEO({
    title: "Nanda Khalif Akbar — Portfolio",
    description:
      "Portfolio Nanda Khalif Akbar: sysadmin & infrastructure engineer. Skills, sertifikat, CV, dan proyek infrastruktur server.",
    path: "/portfolio",
    jsonLd: {
      "@context": "https://schema.org",
      "@type": "Person",
      name: "Nanda Khalif Akbar",
      jobTitle: "Sysadmin & Infrastructure Engineer",
      url: "https://khalif-porto.vercel.app/portfolio",
    },
  });
